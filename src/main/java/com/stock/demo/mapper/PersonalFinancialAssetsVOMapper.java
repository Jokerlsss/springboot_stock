...
@Select("select a.productCode,a.productName,a.productType,b.holdEarn,b.holdingCost,b.dayEarn from financialproduct a,personalfinancialassets b where b.userid=#{userid} and a.productCode=b.productCode")
